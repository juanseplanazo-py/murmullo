    ...
    <div className="min-h-screen bg-warm-50 flex">
          ...
          <div className="max-w-md text-center">
            ...
            <div className="relative">
              ...
              <h2 className="font-serif text-4xl font-bold text-warm-900 mb-4 leading-tight">
                ...
                <span className="text-rose-400 italic block">tu espacio te espera</span>
              </h2>
              <p className="text-warm-600 text-lg leading-relaxed">
                Tus palabras siguen aquí. Sigue escribiendo.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h1 className="font-serif text-3xl font-bold text-warm-900 mb-2">Iniciar sesión</h1>
            <p className="text-warm-500">Regresa a tu espacio creativo</p>
          </div>
